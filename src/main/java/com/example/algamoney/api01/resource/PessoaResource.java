...
import com.example.algamoney.api01.service.PessoaService;
...
public class PessoaResource {
	...
	@GetMapping
	@PreAuthorize("hasAuthority('SCOPE_ROLE_PESQUISAR_PESSOA')")
	public List<Pessoa> listar() {
		return pessoaRepository.findAll();
	}
	
	@PostMapping
	@PreAuthorize("hasAuthority('SCOPE_ROLE_CADASTRAR_PESSOA')")
	...
	@PreAuthorize("hasAuthority('SCOPE_ROLE_REMOVER_PESSOA')")
